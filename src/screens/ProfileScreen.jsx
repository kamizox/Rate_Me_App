...
export default function ProfileScreen({ navigation }) {
  ...
  useEffect(() => {
    ...
    // Jab app band ho tou memory save karne ke liye listeners rok do
    return () => {
      unsubscribeUser();
      unsubscribePosts();
    };
  ...
  const saveProfile = async () => {
    setIsSaving(true);
    try {
      let newPicUrl = userData?.profilePic;
      ...
      <Modal visible={isEditModalVisible} animationType="slide" transparent={true}>
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <TextInput style={[styles.input, { height: 80 }]} value={editBio} onChangeText={setEditBio} multiline />
